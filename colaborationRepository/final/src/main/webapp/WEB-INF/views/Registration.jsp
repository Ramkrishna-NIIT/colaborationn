          ...
          <div class="col-md-6">
            <form:form action="${pageContext.request.contextPath}/register"
              ...
              <div class="form-group">
                ...
                <form:input class="form-control" path="customerName" id="name" placeholder="Enter Name" type="text"/>
              </div>
              <div class="form-group">
                <label class="control-label" for="email">Email address</label>
                 <span style="color: #ff0000">${emailMsg}</span>
                <form:errors path="customerEmail" cssStyle="color: #ff0000" />
                <form:input class="form-control" path="customerEmail" id="email" placeholder="Enter Email" type="email"/>
              </div>
              <div class="form-group">
                <label class="control-label" for="phone">Mobile No.</label>
                <form:input class="form-control" path="customerPhone" id="phone" placeholder="Enter Mobile No." type="text"/>
              </div>
              <div class="form-group">
